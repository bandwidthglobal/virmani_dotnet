...
export class EcommerceComponent implements OnInit {
    ...
    constructor(
        ...
        this.isStaff = this._authenticationService.isStaff;
        this.isDoctor = this._authenticationService.isDoctor;
        this.isUser = this._authenticationService.isUser;
        this.isPatient = this._authenticationService.isPatient;
