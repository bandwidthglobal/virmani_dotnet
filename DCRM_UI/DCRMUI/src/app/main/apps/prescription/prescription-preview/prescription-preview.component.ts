...
@Component({
    ...
    styleUrls: ['./prescription-preview.service.scss'],
...
export class PrescriptionPreviewComponent implements OnInit, OnDestroy {
   ...
   *
   * @param {Router} router
   * @param {InvoicePreviewService} _staffPreviewService
   * @param {CoreSidebarService} _coreSidebarService
   */
  constructor(
    private router: Router,
      private _staffPreviewService: PrescriptionPreviewService,
   ...
   */
  ngOnInit(): void {
      this._staffPreviewService.onInvoicPreviewChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
