...
import { PrescriptionListComponent } from 'app/main/apps/prescription/prescription-list/prescription-list.component';
import { PrescriptionListService } from 'app/main/apps/prescription/prescription-list/prescription-list.service';
...
const routes: Routes = [
    ...
    {
        path: 'edit',
        redirectTo: '/apps/prescription/edit/4989' // Redirection
    }
];
