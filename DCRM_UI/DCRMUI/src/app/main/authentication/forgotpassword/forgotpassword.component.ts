...
export class ForgotPasswordComponent implements OnInit {
    ...
    constructor(private _coreConfigService: CoreConfigService
        , private _formBuilder: UntypedFormBuilder, private _forgotPasswordService: ForgotPasswordService) {
    ...
    sendOtp() {
        ...
        this.loading = true;
        this._forgotPasswordService.sendOtp(this.f.email.value)
            .pipe(first())
            .subscribe(
                data => {
    ...
    onSubmitOtp() {
        ...
        this.loading = true;
        this._forgotPasswordService.submitOtp(this.email, this.fotp.otp.value)
            .pipe(first())
            .subscribe(
                data => {
                    this.error = "";
    ...
    resetPassword() {
        ...
        this.loading = true;
        let forgotPassword = { entityId: this.apiData.entityId, newPassword: this.fpassword.password.value, type: 'user' }
