...
@Injectable()
export class WaitingRoomService implements Resolve<any> {
    rows: any;
    ...
    getWatingRoom(): Promise<any[]> {
        ...
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.get(`${environment.apiUrl}/Appointment/GetWettingRoom`, requestOptions).subscribe((response: any) => {
                this.rows = response;
