...
export class AppointmentEditComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _appointmentEditService: AppointmentEditService, private _formBuilder: UntypedFormBuilder, private _route: ActivatedRoute, private _toastrService: ToastrService) {
    ...
    ngOnInit(): void {
        ...
        this._appointmentEditService.onAppointmentEditChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
            this.drug = response;
        });
    }
    get f() {
