...
export class AppointmentPreviewComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _appointmentPreviewService: AppointmentPreviewService, private _formBuilder: UntypedFormBuilder, private _route: ActivatedRoute, private _toastrService: ToastrService) {
