...
@Injectable()
export class DrugEditService implements Resolve<any> {
    apiData: any;
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): Observable<any> | Promise<any> | any {
        ...
        return new Promise<void>((resolve, reject) => {
            Promise.all([this.getApiData(currentId), this.getCategoryList(), this.getBrandlist()]).then(() => {
                resolve();
            }, reject);
        });
    }
    ...
    update(drug: any) {
        ...
        const requestOptions = { headers: headers };
        // debugger;
        return this._httpClient.post<any>(`${environment.apiUrl}/Drug/Update`, drug, requestOptions);
    }
