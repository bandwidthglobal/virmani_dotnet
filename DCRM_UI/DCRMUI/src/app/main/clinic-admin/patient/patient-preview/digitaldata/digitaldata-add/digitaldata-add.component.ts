...
@Component({
  selector: 'app-digitaldata-add',
  templateUrl: './digitaldata-add.component.html',
  encapsulation: ViewEncapsulation.None
})
export class DigitaldataAddComponent implements OnInit, OnDestroy {
  ...
  closeSidebar() {
    ...
    getData(patientId) {
        this._digitalDataFormService.getApiListData(patientId).subscribe(resp => {
