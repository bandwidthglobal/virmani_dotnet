...
export class PrescriptionAddComponent implements OnInit, OnDestroy {
    ...
    /*public drugItems = [{ id: '', itemName: '', itemQuantity: '', itemCost: '' }];*/
    ...
    constructor(
        ...
        private _route: ActivatedRoute, private _toastrService: ToastrService, private _commonValidationService: CommonValidationService) {
