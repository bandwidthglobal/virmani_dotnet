...
import { repeaterAnimation } from 'app/main/apps/prescription/prescription.animation';
...
export class PrescriptionEditComponent implements OnInit, OnDestroy {
    ...
    public prescription: PrescriptionAddModel = {
        medicine_Category:  "",
        medicine_Company: "",
        brandname: "",
        basic_Salt: "",
    ...
    constructor(
        ...
        private _prescriptionEditService: PrescriptionEditService, private _formBuilder: UntypedFormBuilder, private _route: ActivatedRoute, private _toastrService: ToastrService) {
    ...
    ngOnInit(): void {
        ...
        this._prescriptionEditService.onPrescriptionEditChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
