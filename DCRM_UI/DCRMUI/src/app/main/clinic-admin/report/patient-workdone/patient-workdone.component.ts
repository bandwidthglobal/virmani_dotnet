...
@Component({
    selector: 'app-patient-workdone',
    templateUrl: './patient-workdone.component.html',
    styleUrls: ['./patient-workdone.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class PatientWorkDoneComponent implements OnInit {
  // Public
  public rows;
   ...
   */
  constructor(
      private _reportService: PatientWorkDoneService,
