...
@Injectable()
export class DealerListService implements Resolve<any> {
    rows: any;
    onDealerListChanged: BehaviorSubject<any>;
    ...
    delete(id: any) {
        ...
        const requestOptions = { headers: headers };
        return this._httpClient.delete<any>(`${environment.apiUrl}/Dealer/Delete/` + id, requestOptions);
    }
}
