...
import { repeaterAnimation } from 'app/main/clinic-admin/staff/staff.animation';
...
export class StaffAddComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _drugAddService: StaffAddService, private _formBuilder: UntypedFormBuilder, private _route: ActivatedRoute, private _toastrService: ToastrService) {
